...
public class verifyOsVersion extends SeleniumUtility {

	/**
	 * 
	 * TC-EVT-0097 Verify that, correct OS Version attribute of the sender is sent
	 * with the event under Default Profile Attributes
	 */
	...
	@Test
	public void VerifyCorrectOsVersion() {
		...
		WebElement OsVersion = driver.findElement(By.xpath("//div[@data-i-type='os_version']"));

		js.executeScript("arguments[0].scrollIntoView();", OsVersion);

		System.out.println("this is a Current OS Version : " + OsVersion.getText());

		String ActualOsVersion = OsVersion.getText();
		String ExpectedOsVersion = "NT 4.0";

		Assert.assertEquals(ActualOsVersion, ExpectedOsVersion);
